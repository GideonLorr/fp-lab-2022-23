...
main :: IO ()
main = do
  gameState <- initializeGame Easy
  playGame gameState

playGame :: GameState -> IO ()
playGame gameState = do
  putStrLn $ "Guessed word: " ++ guessedWord gameState
  putStrLn "Enter your guess:"
  guess <- getLine
  updatedGameState <- makeGuess gameState guess
  if guessedWord updatedGameState == word updatedGameState
    then putStrLn "Congratulations! You guessed the word correctly!"
    else do
      putStrLn "Try again!"
